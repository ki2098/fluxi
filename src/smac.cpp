        ...
        for (int j = J0; j <= J1; j ++) {
            for (int k = K0; k <= K1; k ++) {
                if (f_see(F[i][j][k], ACTIVE, MASK1)) {
                    ...
                    f33 =   F[i    ][j    ][k    ];
                    f34 =   F[i    ][j    ][k + 1];
                    m11 = f_see(f11, M_E, MASK1);
                    m12 = f_see(f12, M_E, MASK1);
                    m13 = f_see(f13, M_E, MASK1);
                    m14 = f_see(f14, M_E, MASK1);
                    m21 = f_see(f21, M_N, MASK1);
                    m22 = f_see(f22, M_N, MASK1);
                    m23 = f_see(f23, M_N, MASK1);
                    m24 = f_see(f24, M_N, MASK1);
                    m31 = f_see(f31, M_T, MASK1);
                    m32 = f_see(f32, M_T, MASK1);
                    m33 = f_see(f33, M_T, MASK1);
                    m34 = f_see(f34, M_T, MASK1);
                    f11 = f_see(f11, F_E, MASK8);
                    f12 = f_see(f12, F_E, MASK8);
                    f13 = f_see(f13, F_E, MASK8);
                    f14 = f_see(f14, F_E, MASK8);
                    f21 = f_see(f21, F_N, MASK8);
                    f22 = f_see(f22, F_N, MASK8);
                    f23 = f_see(f23, F_N, MASK8);
                    f24 = f_see(f24, F_N, MASK8);
                    f31 = f_see(f31, F_T, MASK8);
                    f32 = f_see(f32, F_T, MASK8);
                    f33 = f_see(f33, F_T, MASK8);
                    f34 = f_see(f34, F_T, MASK8);
                    epe = (f13)? 0 : 1;
                    epn = (f23)? 0 : 1;
                    ept = (f33)? 0 : 1;
                    epw = (f12)? 0 : 1;
                    ...
                    ub1 =   U[i    ][j    ][k - 1][_U];
                    ub2 =   U[i    ][j    ][k - 2][_U];
                    b11 = f_see(B[f11], BT_U, MASK2);
                    b12 = f_see(B[f12], BT_U, MASK2);
                    b13 = f_see(B[f13], BT_U, MASK2);
                    b14 = f_see(B[f14], BT_U, MASK2);
                    b21 = f_see(B[f21], BT_U, MASK2);
                    b22 = f_see(B[f22], BT_U, MASK2);
                    b23 = f_see(B[f23], BT_U, MASK2);
                    b24 = f_see(B[f24], BT_U, MASK2);
                    b31 = f_see(B[f31], BT_U, MASK2);
                    b32 = f_see(B[f32], BT_U, MASK2);
                    b33 = f_see(B[f33], BT_U, MASK2);
                    b34 = f_see(B[f34], BT_U, MASK2);
                    if (f13) {
                    ...
                    if (f31) {
                        ...
                        ub2 = 2 * bc_eva(b31, ref, dis, BU[i][j][k - 1][_T][_U]) - ub1;
                    }
                    ...
                    ub1 =   U[i    ][j    ][k - 1][_V];
                    ub2 =   U[i    ][j    ][k - 2][_V];
                    b11 = f_see(B[f11], BT_V, MASK2);
                    b12 = f_see(B[f12], BT_V, MASK2);
                    b13 = f_see(B[f13], BT_V, MASK2);
                    b14 = f_see(B[f14], BT_V, MASK2);
                    b21 = f_see(B[f21], BT_V, MASK2);
                    b22 = f_see(B[f22], BT_V, MASK2);
                    b23 = f_see(B[f23], BT_V, MASK2);
                    b24 = f_see(B[f24], BT_V, MASK2);
                    b31 = f_see(B[f31], BT_V, MASK2);
                    b32 = f_see(B[f32], BT_V, MASK2);
                    b33 = f_see(B[f33], BT_V, MASK2);
                    b34 = f_see(B[f34], BT_V, MASK2);
                    if (f13) {
                        _pre_bc_eva(m13, uc0, ue1, ref, dis);
                    ...
                    if (f31) {
                        _pre_bc_eva(m31, ub2, ub1, ref, dis);
                        ub2 = 2 * bc_eva(b31, ref, dis, BU[i][j][k - 1][_T][_V]) - ub1;
                    }
                    ...
                    ub1 =   U[i    ][j    ][k - 1][_W];
                    ub2 =   U[i    ][j    ][k - 2][_W];
                    b11 = f_see(B[f11], BT_W, MASK2);
                    b12 = f_see(B[f12], BT_W, MASK2);
                    b13 = f_see(B[f13], BT_W, MASK2);
                    b14 = f_see(B[f14], BT_W, MASK2);
                    b21 = f_see(B[f21], BT_W, MASK2);
                    b22 = f_see(B[f22], BT_W, MASK2);
                    b23 = f_see(B[f23], BT_W, MASK2);
                    b24 = f_see(B[f24], BT_W, MASK2);
                    b31 = f_see(B[f31], BT_W, MASK2);
                    b32 = f_see(B[f32], BT_W, MASK2);
                    b33 = f_see(B[f33], BT_W, MASK2);
                    b34 = f_see(B[f34], BT_W, MASK2);
                    if (f13) {
                        _pre_bc_eva(m13, uc0, ue1, ref, dis);
                    ...
                    if (f31) {
                        _pre_bc_eva(m31, ub2, ub1, ref, dis);
                        ub2 = 2 * bc_eva(b31, ref, dis, BU[i][j][k - 1][_T][_W]) - ub1;
                    }
